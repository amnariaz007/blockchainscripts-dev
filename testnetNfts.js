...
const testnetProvider = "https://rpc-mumbai.maticvigil.com";
...
const provider = new Provider(ownerPrivateAddress, testnetProvider); // testnet provider change when deploy in mainnet
